...
import { st as definePreviewAddon10 } from "./components-B4wl7fcg.js";
import { t as DocsRenderer } from "./chunk-OATZR77O-iYduIT4c.js";
...
var excludeTags = Object.entries(globalThis.TAGS_OPTIONS ?? {}).reduce((acc, entry) => {
	...
	renderer: async () => {
		let { DocsRenderer } = await import("./DocsRenderer-LL677BLK-CNpeWPW0.js");
